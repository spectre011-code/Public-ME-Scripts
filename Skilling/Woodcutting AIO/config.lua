...
SM:AddTab("Main")
SM:Dropdown("Tree to cut", "Tree", {"None", "Regular tree - North of Burthorpe", "Regular tree - North of Draynor", "Regular tree - South of GE", "Regular tree - Woodcutter grove", "Oak tree - East of Draynor", "Oak tree - South of GE", "Oak tree - South of Varrock", "Oak tree - Woodcutter grove", "Willow tree - South of Draynor", "Willow tree - Woodcutter grove", "Teak tree - Karamja", "Teak tree - Musa Point", "Maple tree - North of Seer's Village", "Acadia tree - Menaphos Imperial District",  "Acadia tree - Menaphos VIP area", "Eucaliptus trees - West of Oo'glog", "Mahogany trees - Karamja", "Yew tree - Edgeville", "Yew tree - South of Seers Village", "Ivy - falador north wall", "Ivy - falador south wall", "Ivy - Taverley east wall", "Ivy - Varrock east castle wall", "Ivy - Woodcutter grove", "Magic tree - North east of Ardougne", "Elder tree - South of Draynor", "Elder tree - South of Yanille", "Elder tree - Woodcutter grove", "Eternal magic tree - North of Eagle's Peak"}, "None")
SM:Dropdown("Where to bank", "Bank", {"Drop logs", "Burthorpe", "Draynor", "Varrock west bank", "Edgeville", "Woodcutters grove - Log pile", "Seer's village", "Menaphos VIP area - Bank chest", "Menaphos Imperial District", "Oo'glog", "Guthix Memorial", "Wars retreat", "Max guild"}, {"Drop logs"})
